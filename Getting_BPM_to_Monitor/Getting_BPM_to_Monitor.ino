...
int PulseSensorPurplePin = 12; // Pulse Sensor WIRE connected to Pin 34
...
void loop() {
  ...
  Signal = analogRead(PulseSensorPurplePin);  // Read the PulseSensor's value.
   ...
   Serial.println(Signal%100);                    // Send the Signal value to Serial Plotter.
...
delay(100); // too higher delay will 
